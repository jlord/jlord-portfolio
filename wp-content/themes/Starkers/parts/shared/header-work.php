<header>
		<div id="card"><p><a href="/welcomehome/"><img class="logo" src="/wp-content/uploads/logo.png" width = "45px"></a><p class="field">MAPPY, DESIGNY, WEBBY</p><p class="name">Jessica Lord</p></div>
		<div id="nav">
			<ul class="left">
				<li><small>work</small></li>
				<li><a class="showall" href="#">ALL</a></li></ul>
				<li><a class="map" href="#">MAPS</a></li>
				<li><a class="graphic" href="#">GRAPHIC</a></li>
				<li><a class="web" href="#">WEB</a></li></ul>
