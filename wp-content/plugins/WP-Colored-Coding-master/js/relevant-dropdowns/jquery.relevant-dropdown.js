/**
 * @source https://github.com/chriscoyier/Relevant-Dropdowns
 *
 * Changelog
 *
 * - 2012-06-02
 *   append the ul-Element not to body but to the parent of the input
 */
  ...
  $.fn.relevantDropdown = function(options) {
	...
	return this.each(function() {
	  ...
	  datalistItems.on("click", function() {
		...
		$datalist.fadeOut(options.fadeOutSpeed);
		datalistItems.removeClass("active");
		item_selected( $( this ).attr( 'data-val' ) );
	  });
